...
const karatsuba = (a, b) => {
    ...
    let a0 = a.splice(0, half);
    let a1 = a
    let b0 = b.splice(0, Math.min(bn, half));
    let b1 = b
...
console.log(karatsuba([4, 3, 2, 1], [8, 7, 6, 5])) // 7006652
console.log(karatsuba([9, 9, 9], [9, 9, 9])) // 998001
console.log(karatsuba([1, 2, 3, 4, 5, 6, 7, 8, 9], [9, 8, 7, 6, 5, 4, 3, 2, 1]))
console.log(karatsuba([8, 9, 3, 7, 2, 4, 3, 5, 8, 4, 9, 3, 2, 8, 4].reverse(), [2, 3, 8, 9, 4, 7, 3, 2, 8, 9, 4, 7, 3, 2, 9].reverse())) // 213553048277135320552236238436
